...
public class ProfilerLineBreakpoint extends Breakpoint<JavaProfilerLineBreakpointProperties> {
    ...
    protected ProfilerLineBreakpoint(Project project, XBreakpoint xBreakpoint) {
...
//    }
    ...
    public SourcePosition getSourcePosition() {
        return this.getMatchingLineBreakpoint().getSourcePosition();
    }
            ...
            try {
                ...
                if(!ex.isEmpty()) {
                    ...
                    while(var4.hasNext()) {
                        ...
                        if(this.acceptLocation(debugProcess, classType, loc)) {
    ...
    public boolean processLocatableEvent(SuspendContextCommandImpl action, LocatableEvent event) throws EventProcessingException {
        ...
        boolean requestHit = super.processLocatableEvent(action, event) && this.getMatchingLineBreakpoint()
                .processLocatableEvent(action, event);
        if (requestHit) {
            for (ProfilerLineBreakpointCallback cb : breakpointHitCallbacks) {
                cb.profilerLineBreakpointHit((ProfilerLineBreakpoint) requestor);
            }
        }
        return requestHit;
    }
    ...
    public void setMatchingLineBreakpoint(LineBreakpoint lineBreakpoint) {
        this.lineBreakpoint = lineBreakpoint;
    }

    public LineBreakpoint getMatchingLineBreakpoint() {
